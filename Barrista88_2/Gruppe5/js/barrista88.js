            ...
            const cleaningFortschritt = document.getElementById("cleaning");
            ...
            const statiscs = document.getElementById("stats")
            ...
            function anAus(){                                                      
                if(power){
                    ...
                    auswahl= "";
                    cleaningFortschritt.classList.add("versteckt");
                }
            }
                ...
                async function reinigungsFortschritt() {                                        
                    zubereitungAktiv = true;
                    cleaningFortschritt.classList.remove("versteckt");
                    ...
                    cleaningFortschritt.innerText = `Reinigung wird durchgeführt...\n[${geladen}${leer}]`;
                    ...
                    cleaningFortschritt.innerText = `Reinigungsvorgang abgeschlossen`;
